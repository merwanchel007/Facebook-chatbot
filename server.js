...
//server.post('/fb', bodyparser.json({ verify: f.verifySignature.call(f) }));
...
server.post('/fb', (req, res) => {
  return f.incoming(req, res, async data => {
    try {
      // postback
      if (data.pb) {
        const answer = data.pb.payload;
        if (answer === "image")
          await f.img(data.sender, 'https://picsum.photos/900/600');
        else if (answer === "gif")
          await f.img(data.sender, 'https://media2.giphy.com/media/ASd0Ukj0y3qMM/giphy.gif');
      }
      else if (data.content === 'Hello') {
        await f.img(data.sender, 'https://media2.giphy.com/media/ASd0Ukj0y3qMM/giphy.gif');
        await f.txt(data.sender, 'Hi there!');
        await f.btn(data.sender);
      }
      //else
...
server.get('/politique', (_, res) => res.send(`<h1>Privacy policy</h1>
<p> This privacy policy (&quot;Policy&quot;) describes how the personally identifiable information (&quot;Personal Information&quot;) you may provide on the <a target="_blank" rel="nofollow" href="https://MessengerChatBotMaximeLMerwanC.maximelouward.repl.co">MessengerChatBotMaximeLMerwanC.maximelouward.repl.co</a> website (&quot;Website&quot; or &quot;Service&quot;) and any of its related products and services (collectively, &quot;Services&quot;) is collected, protected and used. It also describes the choices available to you regarding our use of your Personal Information and how you can access and update this information. This Policy is a legally binding agreement between you (&quot;User&quot;, &quot;you&quot; or &quot;your&quot;) and this Website operator (&quot;Operator&quot;, &quot;we&quot;, &quot;us&quot; or &quot;our&quot;). By accessing and using the Website and Services, you acknowledge that you have read, understood, and agree to be bound by the terms of this Agreement. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.</p>
...
<h2>Contacting us</h2>
<p>If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to individual rights and your Personal Information, you may send an email to &#109;&#108;&#111;&#117;w&#97;r&#100;&#64;g&#109;a&#105;l&#46;&#99;o&#109;</p>
<p>This document was last updated on February 2, 2021</p>`));
server.get('/conditions', (_, res) => res.send("tkt"));